...
export class Backend implements backendInterface {
    ...
    async addMemory(arg0: string, arg1: string, arg2: string): Promise<bigint> {
    ...
    async listMemories(): Promise<Array<Memories>> {
        if (this.processError) {
            try {
                const result = await this.actor.listMemories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMemory(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMemory(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
